"""
URL configuration for mobile_application project.
...
urlpatterns = [
    ...
    path('mobiles/add',views.MobilesCreateView.as_view(),name="mobile-add"),
    path('mobiles/<int:pk>/change',views.MobileUpdateView.as_view(),name="mobile-change"),
    
    path('register',views.SignUpView.as_view(),name="register"),
    path('mobile',views.SignInView.as_view(),name="signin"),
